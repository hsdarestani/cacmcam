...
function ccCameraFont(){
  if(!document.getElementById('cc-estedad-font')){
    const link=document.createElement('link');
    link.id='cc-estedad-font';
    link.rel='stylesheet';
  ...
  style.textContent=`
    body,button,input,select,textarea{font-family:"Estedad","Vazirmatn",Tahoma,Arial,sans-serif!important}
    .state{font-size:9.5px!important}.state b{font-size:11px!important}
    .muted,.health{font-size:10px!important}
    .row .btn{font-size:10px!important}
