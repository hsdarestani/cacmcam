...
function loadCare(){if(careLoaded||window.__camcamPetCareV1)return;careLoaded=true;load('/static/pet_care_v1.js?rev='+rev)}
...
setTimeout(loadCare,4500);
window.__camcamPetBootV2=true;
})();
